...
glMatrixMode(GL_MODELVIEW);
	_textureGrass = loadTexture("img/grass.bmp");
    ...
    glPushMatrix();
        ...
        glBegin(GL_QUADS);
            glTexCoord3f(0.0,70.0,1);  glVertex3f(-72,0,72);
            glTexCoord3f(0.0,0.0,1);  glVertex3f(-72,0,-72);
            glTexCoord3f(70.0,0.0,1);  glVertex3f(72,0,-72);
            glTexCoord3f(70.0,70.0,1);  glVertex3f(72,0,72);
        glEnd();
        glDisable(GL_TEXTURE_2D);
    glPopMatrix();
    
    _textureSky = loadTexture("img/sky.bmp");
    glPushMatrix();
    	glEnable(GL_TEXTURE_2D);
...
//        glRotatef(_angle, 0.0, 1.0, 0.0);
        glBegin(GL_QUADS); //Belakan
            glTexCoord3f(1.0,1.0,0);  glVertex3f(-73,50,-73);
            glTexCoord3f(0.0,0.0,0);  glVertex3f(-73,-50,-73);
            glTexCoord3f(1.0,0.0,0);  glVertex3f(73,-50,-73);
            glTexCoord3f(0.0,1.0,0);  glVertex3f(73,50,-73);
        glEnd();
